...
function Controller(server, config) {
    ...
    logStats.enableProfiling = config.profile;
    this.init();
}
...
Controller.prototype = {
    init: function () {
        ...
        this.songServer = new SongServer(this.config);
    ...
    initSocket: function () {
        ...
        var socket = socketio.listen(this.httpServer);
